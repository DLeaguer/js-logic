...
console.log(graduation(120, 120));
...
function dailySpecials(special){
	switch (special){
		case 'Sunday': return 'Teriyaki Beef';
		case 'Monday': return 'Barbeque Chicken';
		case 'Tuesday': return 'Meat Jun';
		case 'Wednesday': return 'Sweet Sour Spare Ribs';
		case 'Thursday': return 'Barbeque Spare Ribs';
		case 'Friday': return 'Lau Lau Hawaiian Plate';
		case 'Saturday': return 'Spaghetti & Garlic Bread';
